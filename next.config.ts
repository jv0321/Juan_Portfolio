...
export default function Portfolio() {
  ...
  const skills = [
    ...
    { name: "Kali Linux, Wireshark, CompTIA Security+"}
  ];
    ...
    <div className="bg-[#0a192f] text-[#8892b0] min-h-screen font-sans">
      <header className="fixed w-full z-50 bg-[#0a192f]/80 backdrop-blur-sm">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          Cybersecurity Analyst | Full Stack Developer | Air Force Reserve
          </a>
        ...
        <section id="home" className="min-h-screen flex items-center">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              Cybersecurity Analyst and Air Force Reservist
              </h1>
              <p className="text-xl md:text-2xl mb-8">
                Always curious, always learning, always building. Focused on Defensive Security and Information Technology.
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="mb-4">
                    Multi-lingual professional and <strong>Air Force Reservist</strong> transitioning into <strong>Cybersecurity and Information Technology</strong>. I combine military-grade discipline with a Full Stack development background to protect digital infrastructure and build secure, resilient systems.
                  </p>
                  <p className="mb-4">
                  ...
                  <p className="mb-4">
                    I am dedicated to mastering the tools of the trade—from SIEM platforms like Splunk to network analysis with Wireshark. I bring a unique blend of business acumen and technical expertise to every mission.
                  </p>

                  <p className="mb-4">
                    I am proficient in JavaScript, React, Python, and SQL, and I am continuously expanding my knowledge in <strong>Defensive Security Operations (SOC)</strong>, Cloud Security, and Incident Response. I am eager to contribute to high-stakes teams tackling complex security challenges and mission-driven projects.
                  </p>
                  <p className="mb-4">
